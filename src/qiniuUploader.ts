...
interface QiniuUploadOptions {
  ...
  progress?: Taro.uploadFile.UploadTaskProgressCallback;
  cancelTask?: AnyFunction;
  before?: () => void;
  complete?: Taro.uploadFile.ParamPropComplete;
}
...
function doUpload({
  ...
  uploadTask.progress((res: Taro.uploadFile.UploadTaskProgress) => {
